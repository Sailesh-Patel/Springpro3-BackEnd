...
@Sql(scripts = { "classpath:buyer/buyer-schema.sql",
		"classpath:buyer/buyer-data.sql" }, executionPhase = ExecutionPhase.BEFORE_TEST_METHOD)
...
public class BuyerTest {
	...
	void testCreatebuyer() throws InterruptedException {
		...
		WebElement title = this.driver.findElement(By.cssSelector("#buyerTitle"));
		title.sendKeys(buyerTitle);

		String buyerFirstName = "Andrew";
		WebElement firstName = this.driver.findElement(By.cssSelector("#buyersFirstName"));
		firstName.sendKeys(buyerFirstName);

		String buyerSurname = "McCall";
		WebElement surname = this.driver.findElement(By.cssSelector("#buyersSurname"));
		surname.sendKeys(buyerSurname);

		String buyerTel = "01234567998";
		WebElement tel = this.driver.findElement(By.cssSelector("#buyersTel"));
